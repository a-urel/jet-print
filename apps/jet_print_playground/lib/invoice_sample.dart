...
const JetDataSchema invoiceSchema = JetDataSchema(
  ...
  fields: <FieldDef>[
    ...
    FieldDef('customerName',
        type: JetFieldType.string, description: 'Customer name'),
    FieldDef('billingAddress',
        type: JetFieldType.string, description: 'Billing address'),
    FieldDef('date', type: JetFieldType.dateTime, description: 'Invoice date'),
    FieldDef('total',
        type: JetFieldType.double, description: 'Line items subtotal'),
    FieldDef('discountLabel',
        type: JetFieldType.string, description: 'Discount label'),
    FieldDef('discount',
        type: JetFieldType.double, description: 'Discount amount'),
    FieldDef('taxLabel', type: JetFieldType.string, description: 'Tax label'),
    FieldDef('tax', type: JetFieldType.double, description: 'Tax amount'),
    FieldDef('shipping',
        type: JetFieldType.double, description: 'Shipping cost'),
    FieldDef('grandTotal',
        type: JetFieldType.double, description: 'Amount due'),
    FieldDef('paymentTerms',
        type: JetFieldType.string, description: 'Payment terms'),
    FieldDef('shippingMethod',
        type: JetFieldType.string, description: 'Shipping method'),
    FieldDef('notes', type: JetFieldType.string, description: 'Footer notes'),
    FieldDef('invoiceDescription',
        type: JetFieldType.string, description: 'Invoice description'),
    FieldDef(
      'lines',
      ...
      fields: <FieldDef>[
        FieldDef('description',
            type: JetFieldType.string, description: 'Item description'),
        FieldDef('qty', type: JetFieldType.integer, description: 'Quantity'),
        FieldDef('unitPrice',
            type: JetFieldType.double, description: 'Unit price'),
        FieldDef('lineTotal',
            type: JetFieldType.double, description: 'Line total'),
      ],
    ),
  ],
);
              ...
              footer: Band(
                ...
                elements: <ReportElement>[
                  ...
                  ShapeElement(
                    id: 'footerSeparator',
                    bounds:
                        JetRect(x: 0, y: 0, width: _contentWidth, height: 0.75),
                    kind: ShapeKind.rectangle,
