...
/// the painter's decoded-image cache was keyed on the whole `ImagePrimitive`
/// and therefore hashed every byte of every image on every lookup — and,
/// because `bounds` and `elementId` are in `props` too, never hit for a repeated
/// image anyway. It now keys on the byte buffer's identity instead.
///
